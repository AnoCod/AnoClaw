...
export function createDefaultCapabilityCatalog(): CapabilityDefinition[] {
  return [
    ...
    },
    {
      ...
      description: 'Analyze CSV or Excel data and produce an editable workbook, summaries, and recommendations.',
      domain: 'data',
      kind: 'analysis',
      triggers: ['spreadsheet', 'excel', 'xlsx', 'csv', 'table', 'chart', '数据分析', '表格', '图表', 'Excel分析'],
      outputs: [
        { type: 'artifact', label: 'Analysis report', artifactType: 'report' },
        { type: 'file', label: 'Workbook', extension: 'xlsx', artifactType: 'spreadsheet' },
        { type: 'preview', label: 'Markdown analysis', artifactType: 'table_analysis' },
      ],
      requiredTools: ['office.analyze_spreadsheet'],
      artifactTypes: ['spreadsheet', 'table_analysis', 'report'],
      recommendedPlugins: ['anoclaw-office'],
      priority: 86,
    },
    {
